#
# Be sure to run `pod lib lint YATransporter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'YATransporter'
  s.version          = '0.1.0'
  s.summary          = 'A short description of YATransporter.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'YATransporter' => ['YATransporter/Assets/*.png']
  # }
